...
public class LabirintoBuilder {
	...
	public LabirintoBuilder addAdiacenza(String stanzaCorrente, String stanzaAdiecente, String direzione) {
	    ...
	    // 1. Converti la Stringa testuale nel tuo Enum Direzione
	    // (Nota: se i valori nel tuo Enum sono scritti in maiuscolo come NORD, SUD, 
	    // ti consiglio di usare .toUpperCase() sulla stringa per evitare crash).
	    Direzione dir = Direzione.valueOf(direzione.toUpperCase()); 
	    
	    // 2. Passa la variabile correttamente convertita al metodo
	    c.impostaStanzaAdiacente(dir, a);
	...
	public LabirintoBuilder addStanzaBloccata(String nome, String attrezzoSbloccante, String direzioneBloccata) {
	    ...
	    // 1. Converti la stringa in Direzione
	    Direzione dirBloccata = Direzione.valueOf(direzioneBloccata.toUpperCase());
	    
	    // 2. Crea la stanza rispettando l'ordine (String, Direzione, String)
	    Stanza stanza = new StanzaBloccata(nome, dirBloccata, attrezzoSbloccante);
	    
	    this.UltimaStanzaAggiuntaEAggiorna(stanza); // o il nome corretto del tuo metodo
	    return this;
	}
